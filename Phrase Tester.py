...
"'Not all readers are leaders, but all leaders are readers' -- Harry Truman ","chop down the tall poppy","Spawned a maxim of 3 necessities to win a place at a good university is 'Father's wealth, mother's information, child's stamina'",
"Nearly all men can stand adversity, but if you want to test a man's character, give him power.","If you fail 1000 times, you simply just found 1000 ways that wouldn't work", "Not all readers are leaders, but all leaders are readers.",
"Modern technology owes ecology an apology - Allan M. Edison","It is not a gun that kills people, it is people that kills people.","The world is not becoming more violent, it is becoming more televised.", "Don't trust a computer you can't throw out the window - Steve Wozniak",
"Ignoring climate change will be the most costly ofallpossible choices, for us and our children. - Peter Ewins", "It takes courage to age.","We will not track if you type in boobs, but will find you if you type in bombs","Internet of things without security is internet of threats.",
]
def prompt():
